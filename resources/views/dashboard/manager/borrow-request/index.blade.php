...
<p class="text-slate-500 mt-2">
    Monitor employee borrowing activities and review request statuses across the organization.
</p>
        ...
        <div class="overflow-x-auto">
            ...
            <table class="min-w-full">
                ...
                <tr class="text-left">
                    ...
                    <th class="px-6 py-4">Reviewed By</th>
...
@endif
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="flex justify-center gap-2">
                            ...
                            {{-- Detail --}}
                            <a
                                href="{{ route('manager.borrow-request.show',$borrow) }}"
                ...
                <tr>
                    ...
                    <td
                        ...
                        No borrowing activities available.
